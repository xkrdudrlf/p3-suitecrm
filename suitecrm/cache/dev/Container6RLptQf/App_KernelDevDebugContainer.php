...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 3).'/core/backend/Kernel.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Symfony/Bundle/DataCollector/RequestDataCollector.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Symfony/Bundle/DataProvider/TraceableChainCollectionDataProvider.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Symfony/Bundle/DataProvider/TraceableChainItemDataProvider.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Symfony/Bundle/DataProvider/TraceableChainSubresourceDataProvider.php';
            ...
            include_once \dirname(__DIR__, 3).'/vendor/api-platform/core/src/Core/Bridge/Symfony/Bundle/DataPersister/TraceableChainDataPersister.php';
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        $s = ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService());
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($e, \dirname(__DIR__, 3), 'UTF-8'));
     ...
     */
    protected function getApp_Version_ProviderService()
    {
        return $this->services['app.version.provider'] = new \Shivas\VersioningBundle\Provider\VersionProvider(\dirname(__DIR__, 3));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dcB4aMyU7O', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('nePtt7jqR9', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zeplIOOINb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(($this->privates['doctrine.orm.default_annotation_metadata_driver'] ?? $this->getDoctrine_Orm_DefaultAnnotationMetadataDriverService()), 'App');
    ...
    protected function getProfilerService()
    {
        ...
        $d->addInstance('api_platform.graphql.cache.subscription', ($this->privates['api_platform.graphql.cache.subscription'] ?? $this->getApiPlatform_Graphql_Cache_SubscriptionService()));
        ...
        $d->addInstance('shivas_versioning.cache.version', ($this->privates['shivas_versioning.cache.version'] ?? $this->getShivasVersioning_Cache_VersionService()));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ugYDhMf6Xl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NiE4kuqv8x', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1BOMNFvEaR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
     ...
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected function getApiPlatform_Graphql_Cache_SubscriptionService()
    {
        return $this->privates['api_platform.graphql.cache.subscription'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hpIlBqnRzA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E7wJN-HgOc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wfxd1IZV2U', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pzOQbTEb-4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yY9EhVAopI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zgkcmFbJbH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ApiPlatform_DataPersisterService()
    {
        return $this->privates['debug.api_platform.data_persister'] = new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Process\\DataPersister\\ProcessDataPersister'] ?? $this->load('getProcessDataPersisterService'));
            yield 1 => ($this->privates['App\\Process\\DataPersister\\RecordDataPersister'] ?? $this->load('getRecordDataPersisterService'));
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/logs/dev/dev.log'), 100, true, NULL, false);
    ...
    {
        return $this->privates['shivas_versioning.cache.version'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LTOwVw6ALx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getShivasVersioning_ManagerService()
    {
        ...
        $instance->addProvider(($this->services['app.version.provider'] ?? ($this->services['app.version.provider'] = new \Shivas\VersioningBundle\Provider\VersionProvider(\dirname(__DIR__, 3)))), 'version', 100);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.debug' => true,
            'kernel.logs_dir' => (\dirname(__DIR__, 3).'/logs/dev'),
            'kernel.bundles' => [
                    ...
                    'layout' => [
                        ...
                        'actions' => [
                            ...
                            1 => [
                                ...
                                'klass' => [
                                    0 => 'btn stroke-complementary fill-hover-complementary-light fill-complementary border-0 btn-sm p-0 m-0 mr-2',
                                ],
                                'modes' => [
                                    0 => 'detail',
                                    1 => 'edit',
            ...
            'hslavich_onelogin_saml.settings' => [
                ...
                'sp' => [
                    ...
                    'privateKey' => (\dirname(__DIR__, 4).'/html/docroot/certs/key.pem'),
                ],
