...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'api_platform.graphql.cache.subscription' => ($container->privates['api_platform.graphql.cache.subscription'] ?? $container->getApiPlatform_Graphql_Cache_SubscriptionService());
            ...
            yield 'shivas_versioning.cache.version' => ($container->privates['shivas_versioning.cache.version'] ?? $container->getShivasVersioning_Cache_VersionService());
        }, 18));
