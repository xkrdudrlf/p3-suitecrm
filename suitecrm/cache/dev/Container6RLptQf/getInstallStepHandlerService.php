 ...
 */
class getInstallStepHandlerService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Install\\Service\\Installation\\InstallStepHandler'] = new \App\Install\Service\Installation\InstallStepHandler(new RewindableGenerator(function () use ($container) {
            ...
            yield 0 => (isset($container->factories['service_container']['App\\Install\\Service\\Cli\\Steps\\CheckRouteAccess']) ? $container->factories['service_container']['App\\Install\\Service\\Cli\\Steps\\CheckRouteAccess']() : $container->load('getCheckRouteAccessService'));
